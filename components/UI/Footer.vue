  ...
  <footer class="main-footer clearfix" role="contentinfo" :style="style">
    <div class="main-footer__inner">
      <div class="region-footer">
        <div id="block-pane-epa-global-footer" class="block-pane-epa-global-footer">
          <div class="row cols-3">
            ...
            <div class="col size-1of3">
              ...
              <ul class="menu">
                ...
                <li>
                  <a href="https://www.epa.gov/web-policies-and-procedures/epa-disclaimers" class="last">EPA Disclaimers</a>
                </li>
                <li>
...
export default {
  computed: {
    style() {
      return 'position:relative;margin-top: 10px'
    },
  },
}
</script>
